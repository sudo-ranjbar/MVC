...
<head>
    ...
    <link rel="stylesheet" href="<?= $_ENV['HOST'] . "assets/" ?>css/bootstrap.min.css" type="text/css"/>
    <link rel="stylesheet" href="<?= $_ENV['HOST'] . "assets/" ?>fontawesome/css/all.min.css" type="text/css"/>
    <link rel="stylesheet" href="<?= $_ENV['HOST'] . "assets/" ?>css/slick.css" type="text/css"/>
    <link rel="stylesheet" href="<?= $_ENV['HOST'] . "assets/" ?>css/tooplate-simply-amazed.css" type="text/css"/>
    <!--
...
<div id="outer">
    ...
    <main id="content-box" class="order-first">
        <div class="banner-section section parallax-window" data-parallax="scroll"
             data-image-src="<?= $_ENV['HOST'] . "assets/" ?>img/section-1-bg.jpg" id="section-1">
            <div class="container">
                <div class="item">
                    <div class="bg-blue-transparent logo-fa"><span><i class="fas fa-2x fa-atom"></i></span> HAJI
                        ABBASI
                    </div>
                    <div class="bg-blue-transparent simple"><p>Welcome To My House!</p></div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="item col-md-4 one">
                        <div class="tm-work-item-inner">
                            ...
                            <h3>.02 Create It</h3>
                            <p>This is a full-width CSS template with bootstrap 5, you can download, modify and use this
                                layout for your simple CSS website.</p>
                        </div>
                    </div>
        ...
        <section class="gallery-section section parallax-window" data-parallax="scroll"
                 data-image-src="<?= $_ENV['HOST'] . "assets/" ?>img/section-3-bg.jpg" id="section-3">
            <div class="container">
                ...
                <div class="mx-auto gallery-slider">
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-01.jpg" alt="Image">
                        <figcaption>
                            <div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-02.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-03.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-04.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-05.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-06.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-07.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-08.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                    ...
                    <figure class="effect-julia item">
                        <img src="<?= $_ENV['HOST'] . "assets/" ?>img/gallery-img-09.jpg" alt="Image">
                        <figcaption>
                            <div>
                                <p>Julia dances in the deep dark</p>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 contact-details">
                        <div class="tm-contact-item-inner-2">
                            <p>Nam mollis felis elementum, placerat dolor id, vehicula libero. Etiam dui nisl, mattis ut
                                rhoncus et, cursus ut diam.</p>
...
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/jquery-3.3.1.min.js"></script>
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/bootstrap.bundle.min.js"></script>
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/jquery.singlePageNav.min.js"></script>
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/slick.js"></script>
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/parallax.min.js"></script>
<script src="<?= $_ENV['HOST'] . "assets/" ?>js/templatemo-script.js"></script>
</body>
</html>